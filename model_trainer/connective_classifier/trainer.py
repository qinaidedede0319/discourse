...
import json, pickle
from model_trainer.connective_classifier.feature_functions import all_features
...
def do_evaluation(dev_classifier_out_path):
    ...
    precision, recall, f1 = cm.get_prf("1")
    acc = cm.get_accuracy()
...
if __name__ == "__main__":
    ...
    dev_classifier_out_path = config.CONNECTIVE_DEV_OUTPUT_PATH
    ...
    err_case_path = config.CWD+"tmp/error_cases.txt"
